RailsAdmin.config do |config|
  ...
  included_models = [ User, Category, Tour, PhotoGallery, City, FilterWord, WorkRegion, Publication, BrandCarousel, About, Personnel, IndexBanner, ContactsInfo, Service, Regulations, FeedBack]
